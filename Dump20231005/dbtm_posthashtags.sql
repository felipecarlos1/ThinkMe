...
CREATE TABLE `posthashtags` (
  ...
  CONSTRAINT `posthashtags_ibfk_1` FOREIGN KEY (`PostID`) REFERENCES `posts` (`PostID`),
  CONSTRAINT `posthashtags_ibfk_2` FOREIGN KEY (`HashtagID`) REFERENCES `hashtags` (`HashtagID`)
...
INSERT INTO `posthashtags` VALUES (1,1),(3,1),(2,2),(4,2),(1,3),(6,3),(8,4),(5,5),(7,6),(3,7);
...
-- Dump completed on 2023-10-05 22:06:27
